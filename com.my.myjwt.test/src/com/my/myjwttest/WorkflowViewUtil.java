...
public class WorkflowViewUtil {
	...
	/**
	 * get the reference for the given role. the reference should be the role.
	 * 
	 * @param diagram
	 * @param role
	 * @return
	...
	public static Reference getReference(Diagram diagram, Role role) {
		...
		for (Reference ref : refList) {
			...
			if (refELe instanceof Role
					&& WorkflowUtil.comparatorForRole(role, (Role) refELe)) {
				return ref;
			}
		}
		return null;
	...
	public static LayoutData getRoleLayout(Diagram diagram, Role role) {
		...
		// && WorkflowUtil.comparatorForRole((Role) re, role)) {
		// return layoutdata;
		// }
		// }
		// }
