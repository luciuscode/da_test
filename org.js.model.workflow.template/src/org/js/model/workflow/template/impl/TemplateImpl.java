 ...
 * @generated
 */
public class TemplateImpl extends AspectInstanceImpl implements Template {
	/**
		...
		if (action != null && action.eIsProxy()) {
			...
			if (action != oldAction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TemplatePackage.TEMPLATE__ACTION, oldAction, action));
			}
		}
		return action;
	}
	...
	public void setAction(Action newAction) {
		...
		action = newAction;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TemplatePackage.TEMPLATE__ACTION, oldAction, action));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TemplatePackage.TEMPLATE__ACTION:
